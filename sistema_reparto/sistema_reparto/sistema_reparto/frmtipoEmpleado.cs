...
namespace sistema_reparto
{
    public partial class frmtipoEmpleado : Form
    {
        ...
        private void pnlModificarTE_MouseClick(object sender, MouseEventArgs e)
        {
            String estatuTipoEmpleado = "A";
            String idTipoEmpleado = txtIdTipoEmpleado.Text;
            TipoEmpleado tipoE = funObtenerTxt(estatuTipoEmpleado);

            tipoE.funModificar(idTipoEmpleado);
            funCargarTabla(null);
            tipoE.funBuscarSetearTxt(txtIdTipoEmpleado, txtNombreTipoEmpleado, txtEstatusTipoEmpleado, idTipoEmpleado);


        }

        private void pnlLLenarCamposTE_MouseClick(object sender, MouseEventArgs e)
        {
            txtIdTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[0].Value.ToString();
            txtNombreTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[1].Value.ToString();
            txtEstatusTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[2].Value.ToString();
            
        }

        private void pnlBotonBuscarTE_MouseClick(object sender, MouseEventArgs e)
        {
            /* Inicio buscando el dato ingresado por el usuario y llenando mi tabla */
            String buscarTipoEmpleado = txtBuscarTipoEmpleado.Text;
            funCargarTabla(buscarTipoEmpleado);
        ...
        private void pnlLlenarCamposTEDB_MouseClick(object sender, MouseEventArgs e)
        {
            txtIdTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[0].Value.ToString();
            txtNombreTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[1].Value.ToString();
            txtEstatusTipoEmpleado.Text = dgvTipoEmpleado.CurrentRow.Cells[2].Value.ToString();
            ...
            String pidTipoEmpleado = txtIdTipoEmpleado.Text;
            String pestatusEmpleado = tipoE.funBuscarEstatus(pidTipoEmpleado);

            if (pestatusEmpleado == "A")
            {
                pnlActivarTE.Visible = false;
                pnlDarBajaTE.Visible = true;
            }
            else if (pestatusEmpleado == "I")
            {
                pnlDarBajaTE.Visible = false;
                pnlActivarTE.Visible = true;
            }
        }

        private void pnlDarBajaTE_MouseClick(object sender, MouseEventArgs e)
        {
            String estatus = "A";
            String pIdTipoEmpleado = txtIdTipoEmpleado.Text;
            TipoEmpleado tipoE = funObtenerTxt(estatus);

            tipoE.funDarBajaTipoEmpleado();
            funCargarTabla(null);

            pnlActivarTE.Visible = true;
            pnlDarBajaTE.Visible = false;

            tipoE.funBuscarSetearTxt(txtIdTipoEmpleado, txtNombreTipoEmpleado, txtEstatusTipoEmpleado, pIdTipoEmpleado);
        }

        private void pnlActivarTE_MouseClick(object sender, MouseEventArgs e)
        {
            String estatus = "I";
            String pIdTipoEmpleado = txtIdTipoEmpleado.Text;
            TipoEmpleado tipoE = funObtenerTxt(estatus);

            tipoE.funActivarTipoEmpleado();
            funCargarTabla(null);
